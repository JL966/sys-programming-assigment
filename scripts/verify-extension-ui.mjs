...
try{
 ...
 assert(await page.locator('#filter').isDisabled());await page.locator('#toggle-list').click();assert(await page.locator('#filter').isEnabled());await page.locator('#toggle-list').click();assert(await page.locator('#filter').isDisabled());
 ...
 assert.equal(await page.locator('.ABNORMAL').count(),1);await page.locator('#toggle-list').click();await page.locator('#filter').click();assert.equal(await page.locator('.row').count(),23);
 ...
 console.log('PASS: 23 items, power-cycle handoff, identity, manual abnormal, notes, nonnormal filter, mobile overflow, no page errors');
