...
try {
 & node --test tests/js/diagnostic.test.mjs tests/js/diagnostic-runner.test.mjs tests/js/diagnostic-feedback.test.mjs tests/js/diagnostic-messages.test.mjs tests/js/diagnostic-ui.test.mjs tests/js/learning-board.test.mjs tests/js/serial-transport.test.mjs tests/js/extension.test.mjs tests/js/temperature-rise.test.mjs
